...
it ('correct new id', () => {
    const firstArray = [{id: 1, ref: 2}];
    const secondArray = [{id: 1, val: 1}, {id: 2, val: 2}];
    expect(joinArrays(firstArray, secondArray, 'ref', 'id')).toContainEqual({id: 1, ref: 2, val: 2});
    expect(joinArrays(firstArray, secondArray, 'ref', 'id')).not.toContainEqual({id: 2, ref: 2, val: 2});
});